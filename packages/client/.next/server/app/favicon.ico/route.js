    ...
    (A.modules = {
      ...
      2153: (A, e, w) => {
        ...
        let s = 'force-static',
          a = new t.AppRouteRouteModule({
            ...
            resolvedPagePath:
              'next-metadata-route-loader?filePath=%2FUsers%2Fantiyro%2FDocuments%2FProjet%2FKasar%2Fsnak%2Fpackages%2Fclient%2Fsrc%2Fapp%2Ffavicon.ico&isDynamicRouteExtension=0!?__next_metadata_route__',
            nextConfigOutput: '',
            userland: i,
          }),
          { workAsyncStorage: u, workUnitAsyncStorage: c, serverHooks: l } = a;
        function g() {
        ...
        (() => {
              ...
              226: function (t, o) {
                !(function (r, D) {
                  ...
                  var P = 'function',
                    ...
                    U = function (A) {
                      for (var e = {}, w = 0; w < A.length; w++)
                        e[A[w].toUpperCase()] = A[w];
                      return e;
                    },
                    X = function (A, e) {
                      return typeof A === a && -1 !== z(e).indexOf(z(A));
                    },
                    z = function (A) {
                    ...
                    K = function (A, e) {
                      if (typeof A === a)
                        return (
                          (A = A.replace(/^\s\s*/, '')),
                          typeof e === n ? A : A.substring(0, 350)
                        );
                    },
                    W = function (A, e) {
                      for (var w, i, t, o, r, n, a = 0; a < e.length && !r; ) {
                        var u = e[a],
                          c = e[a + 1];
                        for (w = i = 0; w < u.length && !r && u[w]; )
                          if ((r = u[w++].exec(A)))
                            for (t = 0; t < c.length; t++)
                              (n = r[++i]),
                                typeof (o = c[t]) === s && o.length > 0
                                  ? 2 === o.length
                                    ? typeof o[1] == P
                                      ? (this[o[0]] = o[1].call(this, n))
                                      : (this[o[0]] = o[1])
                                    : 3 === o.length
                                      ? typeof o[1] !== P ||
                                        (o[1].exec && o[1].test)
                    ...
                    Z = function (A, e) {
                      for (var w in e)
                        if (typeof e[w] === s && e[w].length > 0) {
                          for (var i = 0; i < e[w].length; i++)
                            if (X(e[w][i], A)) return '?' === w ? D : w;
                        } else if (X(e[w], A)) return '?' === w ? D : w;
                      return A;
                    },
                    _ = {
                      ME: '4.90',
                    ...
                    AA = function (A, e) {
                      if (
                        ...
                        return new AA(A, e).getResult();
                      var w = typeof r !== n && r.navigator ? r.navigator : D,
                        i = A || (w && w.userAgent ? w.userAgent : ''),
                        t = w && w.userAgentData ? w.userAgentData : D,
                        o = e ? J($, e) : $,
                        p = w && w.userAgent == i;
                      return (
                        ...
                        (this.getCPU = function () {
                          var A = {};
                          return (A[f] = D), W.call(A, i, o.cpu), A;
                        }),
                        (this.getDevice = function () {
                          ...
                          return (
                            ...
                            (A[g] = D),
                            W.call(A, i, o.device),
                            p && !A[g] && t && t.mobile && (A[g] = B),
                            p &&
                              'Macintosh' == A[c] &&
                              w &&
                              typeof w.standalone !== n &&
                              w.maxTouchPoints &&
                              w.maxTouchPoints > 2 &&
                              ((A[c] = 'iPad'), (A[g] = h)),
                            A
                        ...
                        (this.getEngine = function () {
                          var A = {};
                          return (
                            (A[l] = D), (A[b] = D), W.call(A, i, o.engine), A
                          );
                        }),
                        (this.getOS = function () {
                          var A = {};
                        ...
                        (this.setUA = function (A) {
                          return (
                            (i =
                              typeof A === a && A.length > 350 ? K(A, 350) : A),
                            this
                          );
                        }),
                        this.setUA(i),
                  ...
                  (AA.VERSION = '1.0.35'),
                    (AA.BROWSER = U([l, b, u])),
                    (AA.CPU = U([f])),
                    (AA.DEVICE = U([c, d, g, p, B, m, h, v, y])),
                    (AA.ENGINE = AA.OS = U([l, b])),
                    typeof o !== n
                      ? (t.exports && (o = t.exports = AA), (o.UAParser = AA))
                      : w.amdO
                        ? void 0 !==
                            (i = function () {
                              return AA;
                            }.call(e, w, e, A)) && (A.exports = i)
                        : typeof r !== n && (r.UAParser = AA);
                  var Ae = typeof r !== n && (r.jQuery || r.Zepto);
                  if (Ae && !Ae.ua) {
                    var Aw = new AA();
                    (Ae.ua = Aw.getResult()),
                      (Ae.ua.get = function () {
                      ...
                      (Ae.ua.set = function (A) {
                        Aw.setUA(A);
                        var e = Aw.getResult();
                        for (var w in e) Ae.ua[w] = e[w];
                      });
                  }
          ...
          function r(A) {
            ...
            var w = (o[A] = { exports: {} }),
              i = !0;
            try {
              t[A].call(w.exports, w, w.exports, r), (i = !1);
            } finally {
              i && delete o[A];
            }
            return w.exports;
      ...
      2540: (A, e, w) => {
        ...
        function n() {
          let A = i.workAsyncStorage.getStore(),
            e = t.workUnitAsyncStorage.getStore();
          if (A) {
            if (
              e &&
              'after' === e.phase &&
              !(0, P.isRequestAPICallableInsideAfter)()
            )
              throw Error(
            ...
            if (e) {
              ...
              'prerender-ppr' === e.type
                ...
                : 'prerender-legacy' === e.type &&
                  (0, o.throwToInterruptStaticGeneration)('connection', A, e);
            }
            (0, o.trackDynamicDataInDynamicRender)(A, e);
          }
      ...
      2449: (A, e, w) => {
        ...
        Object.defineProperty(e, '__esModule', { value: !0 }),
          (function (A, e) {
            for (var w in e)
              Object.defineProperty(A, w, { enumerable: !0, get: e[w] });
          })(e, {
      ...
      8646: (A, e, w) => {
        ...
        let i = w(9946),
          ...
          r = w(7119),
          D = w(9946),
          P = Symbol('internal response'),
          n = new Set([301, 302, 303, 307, 308]);
        function s(A, e) {
          var w;
          if (
            null == A ? void 0 : null == (w = A.request) ? void 0 : w.headers
          ) {
            if (!(A.request.headers instanceof Headers))
              throw Error('request.headers must be an instance of Headers');
            let w = [];
            for (let [i, t] of A.request.headers)
              e.set('x-middleware-request-' + i, t), w.push(i);
            e.set('x-middleware-override-headers', w.join(','));
          }
        }
        class a extends Response {
          constructor(A, e = {}) {
            super(A, e);
            let w = this.headers,
              n = new Proxy(new D.ResponseCookies(w), {
                get(A, t, o) {
                  switch (t) {
                    case 'delete':
                    case 'set':
                      return (...o) => {
                        let r = Reflect.apply(A[t], A, o),
                          P = new Headers(w);
                        return (
                          r instanceof D.ResponseCookies &&
                            w.set(
                              'x-middleware-set-cookie',
                              r
                                .getAll()
                                .map((A) => (0, i.stringifyCookie)(A))
                                .join(',')
                            ),
                          s(e, P),
                          r
                    ...
                    default:
                      return r.ReflectAdapter.get(A, t, o);
                  }
                },
              });
            this[P] = {
              ...
              url: e.url
                ? new t.NextURL(e.url, {
                    headers: (0, o.toNodeOutgoingHttpHeaders)(w),
          ...
          static json(A, e) {
            let w = Response.json(A, e);
            return new a(w.body, w);
          }
          static redirect(A, e) {
            let w =
              'number' == typeof e
                ? e
                : ((null == e ? void 0 : e.status) ?? 307);
            if (!n.has(w))
              throw RangeError(
                'Failed to execute "redirect" on "response": Invalid status code'
              );
            let i = 'object' == typeof e ? e : {},
              t = new Headers(null == i ? void 0 : i.headers);
            return (
              t.set('Location', (0, o.validateURL)(A)),
              new a(null, { ...i, headers: t, status: w })
            );
          }
          static rewrite(A, e) {
            let w = new Headers(null == e ? void 0 : e.headers);
            return (
              w.set('x-middleware-rewrite', (0, o.validateURL)(A)),
              s(e, w),
              new a(null, { ...e, headers: w })
            );
          }
          static next(A) {
      ...
      399: (A, e) => {
        ...
        let w = 'undefined' == typeof URLPattern ? void 0 : URLPattern;
      },
      5498: (A, e, w) => {
        'use strict';
        Object.defineProperty(e, '__esModule', { value: !0 }),
        ...
        function o(A) {
          return { ...(0, i.default)(A), isBot: void 0 !== A && t(A) };
        }
        function r({ headers: A }) {
          return o(A.get('user-agent') || void 0);
        }
      },
    });
