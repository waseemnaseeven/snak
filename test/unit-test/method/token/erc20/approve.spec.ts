...
describe('Approve token spending', () => {
  ...
  it('should approve spender to spend tokens with address token sent', async () => {
    const params = {
      ...
      amount: '1.0',
      assetAddress:
        '0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d' as string,
    };
...
describe('With wrong input', () => {
  it('should fail with invalid token address', async () => {
    const params = {
      ...
      amount: '1.0',
      assetAddress:
        '0x49dddf03a0f0a9e70e28dcd74cbf44931174dbe3cc4b2ffdddddddddddddddd' as string,
    };
