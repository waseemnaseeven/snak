...
export const deleteProgramSchema = z.object({
  projectName: z.string().min(1).describe('The name of the project to delete the program from'),
...
export const deleteDependencySchema = z.object({
  projectName: z.string().min(1).describe('The name of the project to delete the dependency from'),
  dependencyName: z.string().min(1).describe('The name of the dependency to delete')
});
