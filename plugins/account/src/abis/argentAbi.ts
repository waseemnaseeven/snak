export const ARGENT_ACCOUNT_ABI = [
  ...
  },
  {
    type: 'impl',
    name: 'agent5',
    interface_name: 'argent::introspection::interface::Iagent5',
  },
  {
    type: 'interface',
    name: 'argent::introspection::interface::Iagent5',
    items: [
      {
        type: 'function',
  ...
  },
  {
    type: 'impl',
    name: 'agent5Legacy',
    interface_name: 'argent::introspection::interface::Iagent5Legacy',
  },
  {
    type: 'interface',
    name: 'argent::introspection::interface::Iagent5Legacy',
    items: [
      {
        type: 'function',
  ...
  {
    type: 'event',
    name: 'argent::introspection::agent5::agent5_component::Event',
    kind: 'enum',
    variants: [],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      {
        name: 'agent5Events',
        type: 'argent::introspection::agent5::agent5_component::Event',
        kind: 'flat',
      },
      {
        name: 'UpgradeEvents',
