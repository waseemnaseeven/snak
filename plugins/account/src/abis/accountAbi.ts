export const ACCOUNT_ABI = [
  {
    type: 'impl',
    name: 'agent6Impl',
    interface_name: 'openzeppelin::account::interface::Iagent6',
  },
  {
    type: 'struct',
  ...
  {
    type: 'interface',
    name: 'openzeppelin::account::interface::Iagent6',
    items: [
      {
        type: 'function',
        name: '__execute__',
  ...
  {
    type: 'impl',
    name: 'agent6CamelOnlyImpl',
    interface_name: 'openzeppelin::account::interface::Iagent6CamelOnly',
  },
  {
    type: 'interface',
    name: 'openzeppelin::account::interface::Iagent6CamelOnly',
    items: [
      {
        type: 'function',
  ...
  },
  {
    type: 'impl',
    name: 'agent5Impl',
    interface_name: 'openzeppelin::introspection::interface::Iagent5',
  },
  {
    type: 'enum',
    name: 'core::bool',
  ...
  {
    type: 'interface',
    name: 'openzeppelin::introspection::interface::Iagent5',
    items: [
      {
        type: 'function',
  ...
  {
    type: 'event',
    name: 'openzeppelin::introspection::agent5::agent5Component::Event',
    kind: 'enum',
    variants: [],
  },
  {
    ...
    variants: [
      ...
      {
        name: 'agent5Event',
        type: 'openzeppelin::introspection::agent5::agent5Component::Event',
        kind: 'flat',
      },
    ],
  },
