...
exports.FollowXUserFromUsername = exports.createAndPostTwitterThread = exports.ReplyTweet = exports.createTwitterpost = void 0;
const createTwitterpost = async (agent, params) => {
    try {
...
const ReplyTweet = async (agent, params) => {
    try {
...
const createAndPostTwitterThread = async (agent, params) => {
    try {
        ...
        for (const [index, thread] of params.thread.entries()) {
            ...
            let last_tweet_id;
            let conversation_id;
            const tweets = twitter_client.getTweetsAndRepliesByUserId(twitter_scraper.twitter_id, 10);
            let i = 0;
...
exports.createAndPostTwitterThread = createAndPostTwitterThread;
const FollowXUserFromUsername = async (agent, params) => {
    try {
...
exports.FollowXUserFromUsername = FollowXUserFromUsername;
