...
exports.PROD_CONTRACTS = exports.DEV_CONTRACTS = void 0;
exports.getOpusContractAddresses = getOpusContractAddresses;
exports.getOpusContractAddress = getOpusContractAddress;
const starknet_1 = require("starknet");
exports.DEV_CONTRACTS = {
    ...
    flashmint: '0x0726e7d7bef2bcfc2814e0d5f0735b1a9326a98f2307a5edfda8db82d60d3f5f',
...
exports.PROD_CONTRACTS = {
    ...
    flashmint: '0x05e57a033bb3a03e8ac919cbb4e826faf8f3d6a58e76ff7a13854ffc78264681',
...
function getOpusContractAddresses({ chainId, }) {
    if (chainId === starknet_1.constants.StarknetChainId.SN_SEPOLIA) {
        return exports.DEV_CONTRACTS;
    }
    return exports.PROD_CONTRACTS;
}
function getOpusContractAddress({ chainId, contractName, }) {
