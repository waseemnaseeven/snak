export const BRAAVOS_ACCOUNT_ABI = [
  ...
  },
  {
    ...
    name: 'agent5Impl',
    interface_name:
      'braavos_account::introspection::interface::Iagent5WithCamelCase',
  },
  {
    type: 'interface',
    name: 'braavos_account::introspection::interface::Iagent5WithCamelCase',
    items: [
      {
        type: 'function',
  ...
  {
    type: 'event',
    name: 'braavos_account::introspection::agent5::agent5Component::Event',
    kind: 'enum',
    variants: [],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      {
        name: 'agent5Evt',
        type: 'braavos_account::introspection::agent5::agent5Component::Event',
        kind: 'flat',
      },
      {
        name: 'DwlEvent',
