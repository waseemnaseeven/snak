...
export const registerTools = async (
  ...
  StarknetToolRegistry.push({
    ...
    plugins: 'cairocoder',
    description:
      'Generate Cairo code using AI and save it to the database. Requires a prompt describing the code to be generated and a program name.',
  ...
  StarknetToolRegistry.push({
    ...
    plugins: 'cairocoder',
    description:
      'Fix Cairo code using AI and update it in the database. Requires the name of an existing program and an error description.',
