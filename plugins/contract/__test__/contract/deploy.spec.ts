import { deployContract } from 'src/lib/agent/plugins/contract/actions/deploy';
...
describe('Deploy Contract', () => {
  describe('With valid agent and parameters using Sierra and CASM', () => {
    it('should successfully deploy a contract using Sierra and CASM files', async () => {
      const params721 = {
          classHash: '0x71d41bdc7f66d97589517a4a829dd34c9ae25a60a42d2f5ad8ce262dc7e1bfc',
          sierra: 'src/lib/agent/plugins/contract/contract/token_ERC721.contract_class.json',
          casm: 'src/lib/agent/plugins/contract/contract/token_ERC721.compiled_contract_class.json',
          constructorArgs: ['YopToken', 'YOP', 'https://ipfs.io/ipfs/bafybeib6is7rswqmqy4vi4dghro5vzcqaxixslnzkjzerusrusmcdunf4e/', '10', '0x049D0c2F881f9c8A7eE2a02fa46d681f8aca944d7f77E7d8A56ED6416d0a391c']
      }
        
        const result = await deployContract(agent, params721);
    ...
    it('should successfully deploy a contract using Sierra and CASM files', async () => {
        const params20 = {
          classHash: '0x55d9e5d7ba82a3975278caf55b8883d33801e7159903fd1375f29f105bc2cf9',
          ...
          constructorArgs: ['TestToken', 'TTK', '1000000', '0x049D0c2F881f9c8A7eE2a02fa46d681f8aca944d7f77E7d8A56ED6416d0a391c']
      };
        
        const result = await deployContract(agent, params20);
        const parsed = JSON.parse(result);
